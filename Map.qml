...
Item {
    ...
    function addMarkerAtCoordinates(coordinatesParameters)
    {
        map.addMarkerAtCoordinates( coordinatesParameters["latitude"], coordinatesParameters["longitude"] )
    }
